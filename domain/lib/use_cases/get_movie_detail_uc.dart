...
class GetMovieDetailUc extends UseCase<GetMovieDetailUcParams, MovieDetail> {
  GetMovieDetailUc({required this.repository});

  final MovieDataRepository repository;

  @override
  Future<MovieDetail> getRawFuture({required GetMovieDetailUcParams params}) =>
      repository.fetchMovieDetails(params.movieId);
}
